...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        ...
        description="PostgreSQL Database connection URL (MUST be set via DATABASE_URL env var in production)"
    )
    redis_url: str = Field(
    ...
    letta_project_slug: Optional[str] = Field(
        default=None,
        description="Letta project slug for multi-project environments (optional)"
    )
